<?php
	...
	<style type="text/css" media="screen">
		#menu-posts-producto .wp-menu-image {
			background: url('<?php bloginfo('template_url') ?>/images/admin/producto.png') no-repeat 6px -17px !important;
		}
		#menu-posts-producto:hover .wp-menu-image, #menu-posts-producto.wp-has-current-submenu .wp-menu-image {
